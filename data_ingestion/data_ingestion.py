...
def create_db_engine(db_path):
    """
    Creating an engine for a database. 
    
    Parameters:
    db_path (database): a database located in the same directory as this notebook.
    
    Returns:
    Successfully creates the engine
    
    This function uses Logs to show various messages
    """
    try:
...
def query_data(engine, sql_query):
    """
    Runs a SQL query to join multiple tables and connects them.
...
def read_from_web_CSV(URL):
    """
    Imports csv files form the web via pandas package.
